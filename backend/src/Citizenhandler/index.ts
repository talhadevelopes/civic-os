...
citizenHandler.get("/issues", async (req, res) => {
  const { 
    status, 
    severity, 
    category, 
...
citizenHandler.get("/issue/:issueId", async (req, res) => {
...
citizenHandler.post("/issue/:issueId/comment", async (req, res) => {
  const { issueId } = req.params;
...
citizenHandler.delete("/comment/:commentId", async (req, res) => {
...
citizenHandler.post("/issue/:issueId/upvote", async (req, res) => {
  const { issueId } = req.params;
