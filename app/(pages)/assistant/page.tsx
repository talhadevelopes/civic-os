    ...
    <PageShell>
      ...
      <header className="h-16 px-8 flex items-center justify-between sticky top-0 bg-white/80 backdrop-blur-md z-30 border-b border-gray-100/50">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-bold text-gray-900 tracking-tight">Civic AI Assistant</h2>
            <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest">Powered by live platform data</p>
          </div>
        </div>
